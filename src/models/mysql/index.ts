...
const comments = 
  "CREATE TABLE if not EXISTS comments(id int PRIMARY key auto_increment,article_id int,name varchar(16), mail varchar(64), site varchar(64), content text,time DATETIME, pid int)";
